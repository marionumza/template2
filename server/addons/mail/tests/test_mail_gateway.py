...
From: Anon <anon@multitouchpro.com>
To: anon@gmail.com
References: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@multitouchpro.com>
Message-ID: <cb7eaf62-58dc-2017-148c-305d0c78892f@multitouchpro.com>
Date: Wed, 14 Mar 2018 14:26:58 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@multitouchpro.com>
Content-Type: multipart/mixed;
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@multitouchpro.com header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@Multitouchprohq.com designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@multitouchpro.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=Multitouchprohq.com
Return-Path: <soup@Multitouchprohq.com>
Received: from mail2.Multitouchprohq.com (mail2.Multitouchprohq.com. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@Multitouchprohq.com designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
Authentication-Results: mx.google.com;
       dkim=pass header.i=@Multitouchprohq.com header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@Multitouchprohq.com designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@multitouchpro.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=Multitouchprohq.com
Received: from [10.10.31.24] (unknown [91.183.114.50])
	(Authenticated sender: soup)
	by mail2.Multitouchprohq.com (Postfix) with ESMTPSA id 7B571A4085
	for <what@Multitouchprohq.com>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=Multitouchprohq.com; s=mail;
...
To: what@Multitouchprohq.com
From: Soup <soup@Multitouchprohq.com>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@Multitouchprohq.com>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.multitouchpro.com
...
Web: http://www.multitouchpro.com
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.multitouchpro.com">http://www.multitouchpro.com</a> </pre>
  </body>
</html>
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.multitouchpro.com">Flectr=
a</a>.
                        </td>
                      </tr>
                    </tbody>
