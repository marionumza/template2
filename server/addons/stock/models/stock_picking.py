...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        'Show Reserved', default=True, help="If this checkbox is ticked, Multitouchpro will show which products are reserved (lot/serial number, source location, source package).")
