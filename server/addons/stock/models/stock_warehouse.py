...
class Orderpoint(models.Model):
    ...
    product_min_qty = fields.Float(
        ...
        help="When the virtual stock goes below the Min Quantity specified for this field, Multitouchpro generates "
             "a procurement to bring the forecasted quantity to the Max Quantity.")
    product_max_qty = fields.Float(
        'Maximum Quantity', digits=dp.get_precision('Product Unit of Measure'), required=True,
        help="When the virtual stock goes below the Min Quantity, Multitouchpro generates "
