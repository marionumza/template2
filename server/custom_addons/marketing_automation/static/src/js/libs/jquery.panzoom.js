        ...
        g.prototype = {
            ...
            setMatrix: function (a, c) {
                if (!this.disabled) {
                    ...
                    var d, e, f, g, h, i, j, k, l, m, n = +a[0], o = this.$parent,
            ...
            _bind: function () {
                ...
                if (// Bind panzoom events from options
                    ...
                    k.length && l.length && (// preventDefault cancels future mouse events on touch events
                        k.on(f, function (b) {
                            b.preventDefault(),
                                a.zoom()
                        }),
            ...
            _startMove: function (a, d) {
                var e, f, g, h, i, j, k, m, n = this, p = this.options, q = p.eventNamespace, r = this.getMatrix(),
                    s = r.slice(0), t = +s[4], u = +s[5], v = {
                        matrix: r,
                        animate: "skip"
                    };
                // Use proper events
